...
4) A gaussian process potential derived from CCSD(T)/CBS data jointy developed by the [Del Maestro Group](https://delmaestro.org/adrian/) and the [Vogiatzis Group](https://vogiatzis.utk.edu/) at UTK.
